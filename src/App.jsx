...
function DepensesIntv(p){
  ...
  return <div style={{background:T.mid,borderRadius:8,padding:"10px 12px"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      ...
      <button onClick={function(){resetForm();setOpen(function(v){return !v;});}} style={{background:T.primary+"22",border:"1px solid "+T.primary+"44",color:T.primary,borderRadius:6,padding:"5px 10px",fontSize:11,cursor:"pointer",fontWeight:700}}>{open?"Fermer":"+ Dépense"}</button>
    </div>
